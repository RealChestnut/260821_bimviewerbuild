 ...
 * `docs/adr/0005-schedule-schema.md`와 `docs/adr/0006-schedule-schema-v2.md`다. 기준서 17절의 `appear`/`temporary`와
...
/**
 * 선후행 유형. `IfcRelSequence`의 SequenceType에 1:1로 대응한다 (ADR-0006).
 *
